...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-04-2025 a las 23:14:05
...
--
-- Estructura de tabla para la tabla `usuarios_sede`
--

CREATE TABLE `usuarios_sede` (
  `id_usuario` int(11) NOT NULL,
  `id_sede` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Indices de la tabla `usuarios_sede`
--
ALTER TABLE `usuarios_sede`
...
--
-- Filtros para la tabla `usuarios_sede`
--
ALTER TABLE `usuarios_sede`
  ADD CONSTRAINT `usuarios_sede_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuario`),
  ADD CONSTRAINT `usuarios_sede_ibfk_2` FOREIGN KEY (`id_sede`) REFERENCES `sedes` (`id_sede`);
COMMIT;
